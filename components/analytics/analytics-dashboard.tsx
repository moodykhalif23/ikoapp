...
export default function AnalyticsDashboard({
  ...
  return (
    <div className="space-y-4 sm:space-y-8">
      {/* Hero Header */}
      <div className="relative overflow-hidden border bg-gradient-to-br from-emerald-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-950 dark:to-emerald-950/40 dark:border-emerald-900/40 p-3 sm:p-8">
        <div className="absolute -right-16 -top-16 h-28 w-28 sm:h-48 sm:w-48 rounded-full bg-emerald-100/60 dark:bg-emerald-900/30" />
        <div className="absolute -left-16 bottom-0 h-24 w-24 sm:h-40 sm:w-40 rounded-full bg-slate-100/70 dark:bg-slate-800/40" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-5">
        ...
        <Card className="card-brand card-elevated border">
          <CardHeader className="pb-2 sm:pb-4 px-3 sm:px-6 pt-3 sm:pt-6">
            ...
            <CardDescription className="text-[11px] sm:text-sm">Monthly report volume</CardDescription>
          </CardHeader>
        ...
        <Card className="card-brand card-elevated border">
          <CardHeader className="pb-2 sm:pb-4 px-3 sm:px-6 pt-3 sm:pt-6">
            ...
            <CardDescription className="text-[11px] sm:text-sm">Types of incidents reported</CardDescription>
          </CardHeader>
          <CardContent className="px-3 sm:px-6 pb-3 sm:pb-6">
            <div className="h-44 sm:h-72">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Card className="card-brand card-elevated border">
          <CardHeader className="pb-2 sm:pb-4 px-3 sm:px-6 pt-3 sm:pt-6">
            ...
            <CardDescription className="text-[11px] sm:text-sm">Average hours worked per day</CardDescription>
          </CardHeader>
          <CardContent className="px-3 sm:px-6 pb-3 sm:pb-6">
            <div className="h-44 sm:h-72">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Card className="card-brand card-elevated border">
          <CardHeader className="pb-2 sm:pb-4 px-3 sm:px-6 pt-3 sm:pt-6">
            ...
            <CardDescription className="text-[11px] sm:text-sm">Current system status</CardDescription>
          </CardHeader>
          <CardContent className="space-y-2 sm:space-y-3 px-3 sm:px-6 pb-3 sm:pb-6">
            <div className="flex items-center justify-between p-2 sm:p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-base font-medium">Avg Hours / Shift</p>
                  <p className="text-[11px] sm:text-sm text-muted-foreground">Last 30 days</p>
                </div>
              </div>
              <Badge variant="secondary" className="bg-blue-100 text-blue-800 text-[10px] sm:text-xs">
            ...
            <div className="flex items-center justify-between p-2 sm:p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-base font-medium">Reports / Day</p>
                  <p className="text-[11px] sm:text-sm text-muted-foreground">Last 30 days</p>
                </div>
              </div>
              <Badge variant="secondary" className="bg-purple-100 text-purple-800 text-[10px] sm:text-xs">
            ...
            <div className="flex items-center justify-between p-2 sm:p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-base font-medium">Incident Rate</p>
                  <p className="text-[11px] sm:text-sm text-muted-foreground">Per report (30 days)</p>
                </div>
              </div>
              <Badge variant="secondary" className="bg-orange-100 text-orange-800 text-[10px] sm:text-xs">
