  ...
  const renderDashboardContent = () => (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6">
        ...
        <Card className={`card-brand card-elevated relative overflow-hidden border ${reportCardStyles[1].card}`} sx={{ p: { xs: 1, sm: 2.5 }, gap: { xs: 0.5, sm: 1.5 } }}>
          <div className={`pointer-events-none absolute -right-10 -top-10 h-24 w-24 rounded-full ${reportCardStyles[1].bubble}`} />
          <div className={`pointer-events-none absolute -left-12 bottom-0 h-20 w-20 rounded-full ${reportCardStyles[1].bubble2}`} />
          <CardHeader className="pb-2 sm:pb-3 relative z-10">
            <CardTitle className="text-xs sm:text-sm font-medium text-brand-contrast flex items-center justify-between">
              Submitted Reports
